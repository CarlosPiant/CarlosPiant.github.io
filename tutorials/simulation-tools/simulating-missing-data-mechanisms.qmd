...
subtitle: "Creating MCAR, MAR, and MNAR response indicators from a known complete dataset"
---
...
The design follows Rubin's classic distinction between missing completely at random, missing at random, and missing not at random @rubin1976, with additional practical framing from Little and Rubin's broader treatment of missing-data mechanisms @littlerubin2019. The setting is a simplified health-services example in which patient severity may be missing from a follow-up dataset used to study annual health-care costs.
...
Rubin's original paper remains the foundational conceptual statement of MCAR, MAR, and MNAR @rubin1976. Little and Rubin provide the standard book-length treatment that connects those ideas to modeling and inference in practical data analysis @littlerubin2019.
