...
subtitle: "Creating strong, weak, and invalid instruments from a known endogenous-treatment process"
---
...
Imbens and Angrist remain the central reference for the local causal interpretation of IV estimates @imbens1994. Staiger and Stock are essential for understanding how weak instruments distort finite-sample IV performance @staiger1997, and Stock, Wright, and Yogo provide a broader weak-identification perspective that is useful when building simulation benchmarks @stockwrightyogo2002. The empirical illustration by Angrist and Evans remains a classic example of instrument-based identification through quasi-random encouragement-like variation @angrist1998.
