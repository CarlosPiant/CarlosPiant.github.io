...
For a real-world example, we use the public `birthwt` data distributed with `MASS` @venables2002mass. The application is the familiar question of whether maternal smoking contributes to low birth weight. This is not a literal reproduction of a published figure. It is a transparent teaching diagram built around a real epidemiologic setting and a public dataset, with the graph structure motivated by standard DAG reasoning in observational health research @greenland1999; @textor2016.
