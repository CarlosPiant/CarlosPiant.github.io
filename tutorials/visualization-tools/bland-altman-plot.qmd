...
Bland and Altman's original papers remain the essential starting point because they explain both the logic of the plot and the difference between agreement and correlation @bland1986; @bland1999. The Pima diabetes dataset comes from the work of Smith and colleagues and provides a convenient public setting for illustrating agreement between quantitative prediction methods @smith1988.
