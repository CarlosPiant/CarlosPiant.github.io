...
For a real-world example, we use the public North Carolina county dataset bundled with `sf`. These polygons include counts of births and sudden infant death cases in 1974 and 1979 and have long served as a teaching example in spatial epidemiology and disease mapping @bivandpebesmagomez2013; @pebesma2018sf. The figure below maps the 1979 sudden infant death syndrome rate per 1,000 births across counties.
...
For a broad treatment of areal data and mapping practice in R, Bivand, Pebesma, and Gomez-Rubio remain the core reference @bivandpebesmagomez2013. Pebesma's article on simple features is the key reference for modern spatial workflows in R @pebesma2018sf. For readers who want to move from descriptive maps to formal spatial analysis, the spatial-association and areal-data references already used elsewhere in the book are natural next steps @bivandwong2018; @bivand2022areal.
