...
Sonnenberg and Beck remain a foundational guide to why Markov models became important in medical decision making @sonnenberg1993. Briggs and Sculpher provide a classic health-economic introduction to state-transition models @briggs1998markov. For a concrete applied setting, Briggs and colleagues' hip-replacement analysis is a useful reminder that decision-analytic diagrams are often the fastest way to explain a cost-effectiveness model before turning to its results @briggs1998thr; @hunink2014.
