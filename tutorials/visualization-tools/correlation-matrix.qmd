...
For the real-world prediction problem underlying the dataset used here, Smith and coauthors provide the original diabetes application @smith1988. A natural next step after this chapter is to compare Pearson and Spearman correlation heatmaps on the same data, or to build a clustered correlation matrix for one of the larger clinical or claims-based datasets used elsewhere in the book.
