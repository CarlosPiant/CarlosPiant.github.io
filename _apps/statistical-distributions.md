---
title: "Statistical Distributions Simulator"
collection: apps
permalink: /apps/statistical-distributions/
...
{% else %}
<p><strong>Embed link not set yet.</strong> Add a deployed Shiny URL to <code>app_url</code> in this file to show the live app.</p>
{% endif %}

## How to Use

- Choose a distribution and set its parameters in the left panel.
- Select the number of samples and the plot type.
- Click "Update Plots" to refresh the PDF/PMF and CDF tabs.
...
```r
install.packages(c("shiny", "ggplot2", "halfmoon"))
```

2. Run the app:

```r
shiny::runApp("apps/statistical-distributions")
```
