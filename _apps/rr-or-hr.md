---
title: "RR, OR, and HR Explorer"
collection: apps
permalink: /apps/rr-or-hr/
subtitle: "Compare time-varying risk ratio, odds ratio, and hazard ratio"
description: "Interactive Shiny app that contrasts RR, OR, and HR over time for control vs treatment using Exponential or Weibull survival models."
app_url: "https://cpineda.shinyapps.io/App_RR_HR_OR/"
hide_author_avatar: true
---

This app helps you understand how RR, OR, and HR differ over time as survival curves diverge between control and treatment. It uses exponential or Weibull survival models and computes time-varying risk, odds, and hazard-based effect measures.

## Live App

<p><a class="btn btn--primary" href="{{ page.app_url }}" target="_blank" rel="noopener">Open the app</a></p>
<iframe src="{{ page.app_url }}" style="width: 100%; height: 800px; border: 1px solid #e5e7eb; border-radius: 8px;" loading="lazy"></iframe>

## How to Use

- Choose **Exponential** or **Weibull** distribution.
- Set the control and treatment parameters (rates for exponential; shape/scale for Weibull).
- If using Weibull, toggle **Proportional hazards** to force equal shapes (constant HR).
- Adjust the time range and number of points.
- Use **Clip extreme metric values** to avoid large spikes when risk is near zero.
- Review outputs in the **Survival curves** and **RR/HR/OR vs time** tabs.

## What You Are Seeing

- **Survival curves** show S(t) for control and treatment.
- **Risk** is defined as 1 - S(t).
- **RR(t)** compares risk in treatment vs control over time.
- **OR(t)** compares odds in treatment vs control over time.
- **HR(t)** compares hazards; it is constant under exponential and only constant under Weibull if shapes are equal.
...
```r
shiny::runApp("apps/rr-or-hr")
```

## Source Code

You can view the raw file here: `/Users/carlospineda/Documents/GitHub/CarlosPiant.github.io/apps/rr-or-hr/app.R`
